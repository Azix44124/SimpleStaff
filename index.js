...
bot.on("message", async message => {
  ...
  if(message.channel.type === "dm") {
      ...
      client.users.get("336611522229043202").send(embed)
    }

  if(cmd === `${prefix}invite`){

    let invitelink = "https://discordapp.com/api/oauth2/authorize?client_id=511172053374599198&permissions=8&scope=bot";
